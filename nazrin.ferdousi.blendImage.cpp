...
To compile: g++ -O3 -w nazrin.ferdousi.blendImage.cpp -lpthread -o nazrin.ferdousi.blendImage

To run: ./nazrin.ferdousi.blendImage InputFile outFile  window_size thread_count
Example: ./nazrin.ferdousi.blendImage rover.jpg test.jpg 3 2
*/
